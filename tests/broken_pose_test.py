...
# https://github.com/TITHI-KHAN/Real-time-Pose-Estimation-using-MediaPipe-and-OpenCV/blob/main/body2_Real-time%20Pose%20Estimation%20using%20MediaPipe%20and%20OpenCV.py
# https://github.com/ecd1012/rpi_pose_estimation/blob/main/get_py_requirements.sh
# https://medium.com/analytics-vidhya/pose-estimation-on-the-raspberry-pi-4-83a02164eb8e

# python3 motion_detection.py --modeldir posenet_mobilenet_v1_100_257x257_multi_kpt_stripped.tflite --output_path pose_images
...
try:
    ...
    while True:
        ...
        #if not led_on and not GPIO.input(button_pin):
        if True:
            ...
            while True:
                ...
                # Press 'q' to quit
                if cv2.waitKey(1) == ord('q') or led_on and not GPIO.input(button_pin):
